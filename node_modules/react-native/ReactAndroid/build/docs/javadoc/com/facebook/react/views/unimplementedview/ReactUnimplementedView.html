...
<title>ReactUnimplementedView (ReactAndroid 0.62.3 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="ReactUnimplementedView (ReactAndroid 0.62.3 API)";
        }
    }
    catch(err) {
    }
...
<ul class="navList">
<li>上一个类</li>
<li><a href="../../../../../com/facebook/react/views/unimplementedview/ReactUnimplementedViewManager.html" title="com.facebook.react.views.unimplementedview中的类"><span class="typeNameLink">下一个类</span></a></li>
</ul>
<ul class="navList">
<li><a href="../../../../../index.html?com/facebook/react/views/unimplementedview/ReactUnimplementedView.html" target="_top">框架</a></li>
<li><a href="ReactUnimplementedView.html" target="_top">无框架</a></li>
</ul>
...
<ul class="subNavList">
<li>概要:&nbsp;</li>
<li><a href="#nested.classes.inherited.from.class.android.widget.LinearLayout">嵌套</a>&nbsp;|&nbsp;</li>
<li><a href="#fields.inherited.from.class.android.widget.LinearLayout">字段</a>&nbsp;|&nbsp;</li>
...
<h2 title="类 ReactUnimplementedView" class="title">类 ReactUnimplementedView</h2>
</div>
...
<li>
<ul class="inheritance">
<li>com.facebook.react.views.unimplementedview.ReactUnimplementedView</li>
</ul>
</li>
</ul>
</li>
...
<hr>
<br>
<pre>public class <span class="typeNameLabel">ReactUnimplementedView</span>
extends android.widget.LinearLayout</pre>
</li>
</ul>
</div>
<div class="summary">
...
<h3>嵌套类概要</h3>
<ul class="blockList">
<li class="blockList"><a name="nested.classes.inherited.from.class.android.widget.LinearLayout">
<!--   -->
</a>
<h3>从类继承的嵌套类/接口&nbsp;android.widget.LinearLayout</h3>
<code>android.widget.LinearLayout.LayoutParams</code></li>
</ul>
<ul class="blockList">
...
<h3>字段概要</h3>
<ul class="blockList">
<li class="blockList"><a name="fields.inherited.from.class.android.widget.LinearLayout">
<!--   -->
</a>
<h3>从类继承的字段&nbsp;android.widget.LinearLayout</h3>
<code>HORIZONTAL, SHOW_DIVIDER_BEGINNING, SHOW_DIVIDER_END, SHOW_DIVIDER_MIDDLE, SHOW_DIVIDER_NONE, VERTICAL</code></li>
</ul>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a href="../../../../../com/facebook/react/views/unimplementedview/ReactUnimplementedView.html#ReactUnimplementedView-android.content.Context-">ReactUnimplementedView</a></span>(android.content.Context&nbsp;context)</code>&nbsp;</td>
</tr>
</table>
</li>
</ul>
...
<h3>构造器详细资料</h3>
<a name="ReactUnimplementedView-android.content.Context-">
<!--   -->
</a>
<ul class="blockListLast">
<li class="blockList">
<h4>ReactUnimplementedView</h4>
<pre>public&nbsp;ReactUnimplementedView(android.content.Context&nbsp;context)</pre>
</li>
</ul>
</li>
</ul>
