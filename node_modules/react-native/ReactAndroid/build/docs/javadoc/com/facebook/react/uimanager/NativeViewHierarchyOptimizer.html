...
<title>NativeViewHierarchyOptimizer (ReactAndroid 0.55.4 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="NativeViewHierarchyOptimizer (ReactAndroid 0.55.4 API)";
        }
    }
    catch(err) {
    }
...
<div class="block">Class responsible for optimizing the native view hierarchy while still respecting the final UI
 ...
 between <a href="../../../../com/facebook/react/uimanager/UIManagerModule.html" title="com.facebook.react.uimanager中的类"><code>UIManagerModule</code></a>, which directly receives view commands from JS, and
 <a href="../../../../com/facebook/react/uimanager/UIViewOperationQueue.html" title="com.facebook.react.uimanager中的类"><code>UIViewOperationQueue</code></a>, which enqueues actual operations on the native view hierarchy. It
 ...
 - Create a view with only layout props: a description of that view is created as a
   <a href="../../../../com/facebook/react/uimanager/ReactShadowNode.html" title="com.facebook.react.uimanager中的接口"><code>ReactShadowNode</code></a> in UIManagerModule, but this class will not output any commands to
