...
<title>FpsView (ReactAndroid 0.62.3 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="FpsView (ReactAndroid 0.62.3 API)";
        }
    }
    catch(err) {
    }
...
<div class="block">View that automatically monitors and displays the current app frame rate. Also logs the current
 ...
 <p>NB: Requires API 16 for use of FpsDebugFrameCallback.</div>
</li>
</ul>
</div>
<div class="summary">
