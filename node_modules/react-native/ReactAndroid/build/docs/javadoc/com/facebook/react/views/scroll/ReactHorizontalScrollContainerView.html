...
<title>ReactHorizontalScrollContainerView (ReactAndroid 0.55.4 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="ReactHorizontalScrollContainerView (ReactAndroid 0.55.4 API)";
        }
    }
    catch(err) {
    }
