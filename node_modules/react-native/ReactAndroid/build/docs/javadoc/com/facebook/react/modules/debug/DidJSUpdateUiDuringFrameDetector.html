...
<title>DidJSUpdateUiDuringFrameDetector (ReactAndroid 0.62.3 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="DidJSUpdateUiDuringFrameDetector (ReactAndroid 0.62.3 API)";
        }
    }
    catch(err) {
    }
...
<div class="subNav">
<ul class="navList">
<li><a href="../../../../../com/facebook/react/modules/debug/DevSettingsModule.html" title="com.facebook.react.modules.debug中的类"><span class="typeNameLink">上一个类</span></a></li>
...
<div class="block">Debug object that listens to bridge busy/idle events and UiManagerModule dispatches and uses it
 ...
 a <a href="../../../../../com/facebook/react/bridge/ReactBridge.html" title="com.facebook.react.bridge中的类"><code>ReactBridge</code></a> and a <a href="../../../../../com/facebook/react/uimanager/UIManagerModule.html" title="com.facebook.react.uimanager中的类"><code>UIManagerModule</code></a>, <a href="../../../../../com/facebook/react/modules/debug/DidJSUpdateUiDuringFrameDetector.html#getDidJSHitFrameAndCleanup-long-long-"><code>getDidJSHitFrameAndCleanup(long, long)</code></a> should
 be called once per frame via a <code>ChoreographerCompat.FrameCallback</code>.</div>
</li>
</ul>
</div>
<div class="summary">
...
<td class="colLast"><code><span class="memberNameLink"><a href="../../../../../com/facebook/react/modules/debug/DidJSUpdateUiDuringFrameDetector.html#onBridgeDestroyed--">onBridgeDestroyed</a></span>()</code>
<div class="block">Called when the bridge is destroyed</div>
</td>
</tr>
...
<div class="block">Called once all pending JS calls have resolved via an onBatchComplete call in the bridge and
 ...
 timer, touch event, etc. causes a Java->JS call to be enqueued again.</div>
<dl>
...
<a name="onBridgeDestroyed--">
<!--   -->
</a>
<ul class="blockList">
<li class="blockList">
<h4>onBridgeDestroyed</h4>
<pre>public&nbsp;void&nbsp;onBridgeDestroyed()</pre>
<div class="block"><span class="descfrmTypeLabel">从接口复制的说明:&nbsp;<code><a href="../../../../../com/facebook/react/bridge/NotThreadSafeBridgeIdleDebugListener.html#onBridgeDestroyed--">NotThreadSafeBridgeIdleDebugListener</a></code></span></div>
<div class="block">Called when the bridge is destroyed</div>
<dl>
<dt><span class="overrideSpecifyLabel">指定者:</span></dt>
<dd><code><a href="../../../../../com/facebook/react/bridge/NotThreadSafeBridgeIdleDebugListener.html#onBridgeDestroyed--">onBridgeDestroyed</a></code>&nbsp;在接口中&nbsp;<code><a href="../../../../../com/facebook/react/bridge/NotThreadSafeBridgeIdleDebugListener.html" title="com.facebook.react.bridge中的接口">NotThreadSafeBridgeIdleDebugListener</a></code></dd>
</dl>
</li>
</ul>
...
<div class="block">Designed to be called from a <code>ChoreographerCompat.FrameCallback#doFrame</code> call.
 ...
 <p>There are two 'success' cases that will cause <a href="../../../../../com/facebook/react/modules/debug/DidJSUpdateUiDuringFrameDetector.html#getDidJSHitFrameAndCleanup-long-long-"><code>getDidJSHitFrameAndCleanup(long, long)</code></a> to return
 ...
 <p>NB2: This makes the assumption that onViewHierarchyUpdateEnqueued is called from the <a href="../../../../../com/facebook/react/uimanager/UIManagerModule.html#onBatchComplete--"><code>UIManagerModule.onBatchComplete()</code></a>, e.g. while the bridge is still considered busy, which means
