...
public class TouchTargetHelper {
  ...
  private static View findClosestReactAncestor(View view) {
     ...
     */
    private static View findTouchTargetView(float[] eventCoords, View view, EnumSet<TouchTargetReturnType> allowReturnTouchTargetTypes) {
    ...
    private static @Nullable View findTouchTargetViewWithPointerEvents(
        ...
        if (pointerEvents == PointerEvents.NONE) {
            ...
            if (view instanceof ReactCompoundViewGroup && isTouchPointInView(eventCoords[0], eventCoords[1], view)
